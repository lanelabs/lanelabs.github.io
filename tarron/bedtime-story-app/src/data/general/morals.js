...
export const morals = [
  ...
  { full: "It's okay to be scared", about: 'being okay with feeling scared' },
  { full: "Failing doesn't make you a failure", about: 'learning from failure' },
  { full: 'Change can be a good thing', about: 'embracing change' },
  { full: "It's okay to feel sad sometimes", about: 'being okay with sadness' },
  { full: 'Saying sorry takes real courage', about: 'the courage to apologize' },
  { full: 'Words can hurt, so choose them carefully', about: 'choosing your words carefully' },
  { full: 'A little help goes a long way', about: 'how a little help goes a long way' },
  { full: 'Sometimes letting go is the bravest thing', about: 'having the courage to let go' },
  { full: "You don't have to be perfect to be good", about: 'being good without being perfect' },
  { full: "Just because something is hard doesn't mean it's not worth doing", about: 'doing hard things that are worth it' },
  { full: 'The quietest voice can have the most to say', about: 'listening to the quietest voices' },
  { full: 'Take care of the world around you', about: 'taking care of the world' },
  { full: 'What makes you different makes you strong', about: 'finding strength in being different' },
  { full: 'Trust has to be earned', about: 'earning trust' },
  { full: 'Being sorry means trying to do better', about: 'being sorry and doing better' },
