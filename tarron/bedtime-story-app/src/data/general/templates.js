...
export const templates = [
  ...
  // Structure: two-para | Rhythm: flowing | Item-role: key | Scale: neutral | Genre-feel: neutral
  '{Character1.emotional} and {character2} cross paths in {setting}. Neither expects much of it — until {hook}.\n\n{Weather}, {item} points the way toward {storyShape} — {aTone} tale about {moral.about}.',
  ...
  // Structure: two-para | Rhythm: flowing | Item-role: key | Scale: neutral | Genre-feel: neutral
  '{AWeatherAdj} {setting.bare} is where {character1} first meets {character2.emotional}. Everything seems ordinary enough — until {hook}.\n\n{Item} holds the key, and before long their {storyShape.bare} is underway. A {tone} tale that reminds us: {Moral}.',
  ...
  'The rule in {setting} was simple: never touch {item}. {Character1.emotional} wasn\'t good with rules.\n\nNow, {weather}, {character2} is involved too — and what started as one broken rule has become {hook}. Their {storyShape.bare} won\'t be easy. A {tone} tale about {moral.about}.',
