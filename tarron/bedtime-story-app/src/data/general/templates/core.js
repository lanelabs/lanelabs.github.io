...
export const templates = [
  ...
  // Shape: discovery
  '{Setting.placed|event.placed} {weather}, {character1.emotional} and {character2} are drawn together — and straight into {hook}.\n\nWith {item}, the discovery unfolds — {aTone} tale about {wish.bare} and {moral.about}.',
  ...
  '{Character1.emotional} and {character2} cross paths {setting.placed|event.placed}. Neither expects much of it — until {hook.verb}.\n\n{Weather}, {item} points the way toward an adventure neither one planned — {aTone} tale about {wish.bare} and {moral.about}.',
  ...
  // Structure: two-para | Rhythm: flowing | Item-role: key | Scale: neutral | Genre-feel: neutral
  // Shape: hidden-truth
  '{Weather}, {setting|event} holds a secret — {hook}. {Character1.emotional} and {character2} are both drawn in, and before long they\'re deeper than either one expected.\n\nWith {item}, the hidden truth starts to surface — {aTone} story about {wish.bare} and {moral.about}.',
  ...
  // Shape: quest
  '{Hook} — that\'s what brings {character1} and {character2.emotional} together {setting.placed|event.placed}. At first, neither knows where it will lead.\n\n{Weather}, {item} holds the key to the quest ahead — a story of {tone.noun}, {wish.bare}, and {moral.about}.',
  ...
  // Structure: two-para | Rhythm: flowing | Item-role: key | Scale: neutral | Genre-feel: neutral
  // Shape: puzzle
  '{AWeatherAdj} {setting.bare|event.bare} is where {character1} first meets {character2.emotional}. Everything seems ordinary enough — until {hook.verb}.\n\n{Item} holds the key, and before long the puzzle takes shape. A {tone} tale about {wish.bare} — one that reminds us: {Moral}.',
  ...
  '{Setting.placed|event.placed}, {character1.emotional} and {character2} stumble into {hook}. At first it seems manageable — but things quickly grow more complicated.\n\n{Weather}, {item} changes everything — turning their path into something transforming. All they wanted was {wish}. It\'s {aTone} tale about {moral.about}.',
  ...
  // Structure: two-para | Rhythm: mixed | Item-role: key | Scale: neutral | Genre-feel: neutral
  // Shape: rescue
  '{Character1} and {character2.emotional} meet {setting.placed|event.placed}. It doesn\'t take long before they\'re face to face with {hook}.\n\n{Weather}, {item} becomes their only hope. What once seemed simple turns into a rescue — a {tone} story about {wish.bare} and {moral.about}.',
  ...
  'They say that {setting.placed|event.placed}, {weather}, every generation faces {hook}. {Character1.emotional} believes it. {Character2} thinks it\'s nonsense.\n\nBut when {item} appears out of nowhere, the curse stirs whether they\'re ready or not — {aTone} story about {wish.bare} and {moral.about}.',
  ...
  '{Character1.emotional} wants nothing to do with {hook}. But {setting.placed|event.placed}, they\'re the only {role} who can help — and {character2} is counting on them.\n\n{Weather}, {item} might be the answer. One step at a time, reluctance gives way — because what they really want is {wish}. A {tone} tale about {moral.about}.',
  ...
  // Shape: trust-to-earn
  '"I don\'t trust you." "Good — I don\'t trust you either." {Character1} and {character2.emotional} find themselves {setting.placed|event.placed}, {weather}, forced together by {hook}.\n\nDistrust gives way to something unexpected. With {item} between them, trust must be earned — {aTone} tale about {wish.bare} and {moral.about}.',
  ...
  'This is not a gentle story. This is {aWeatherAdj} night {setting.placed|event.placed}, where {character1.emotional} has just stumbled into {hook} — and nothing about it is simple.\n\nBut here\'s the thing: {character2} shows up anyway — a {role}, carrying {item} like it matters. And it does. What felt impossible becomes a test of courage, full of {tone.noun}, where {wish.bare} and {moral.about} are tested with every step.',
  ...
  'Once upon a time, {character1} — the {role} — rescued {character2.emotional}. Actually, it was the other way around. {Setting.placed|event.placed}, {weather}, things are rarely what they seem.\n\n{Hook} brought them together, and {item} kept them going. Nothing about it was ordinary — {aTone} tale of mistaken identity, {wish.bare}, and {moral.about}.',
  ...
  'I keep wondering — what if {hook} only showed up {setting.placed|event.placed}? What if {character1.emotional} was the only one who noticed? {Weather}, it seems like the kind of question you\'re not supposed to ask.\n\nBut {character2} noticed too. And {item} makes the secret impossible to ignore. All they wanted was {wish} — a {tone} story about {moral.about}.',
  ...
  'Something is wrong {setting.placed|event.placed}. You can feel it — {weather}, the air itself seems to hold its breath. {Character1.emotional} knows it. {Character2} knows it. Neither will say what.\n\n{Item} sits between them, waiting. {Hook} set all of this in motion. Now the stranger\'s need unfolds in the hush — {aTone}, quiet story about {wish.bare} and {moral.about}.',
  ...
  // Shape: journey-home
  'Let me tell you about the time the {character1.emotional.bare} — the {role} everyone counted on — left {setting|event}. Last time, it didn\'t go well. This time — {weather}, with {hook} hanging over everything — would be different.\n\n{Character2} came along, carrying {item}. The journey out was wild. The journey home was wilder — full of the kind of {tone.noun} that only comes from {wish.bare} and {moral.about}.',
  ...
  '{Character1.emotional} has been trapped by {hook} for as long as anyone can remember.\n\nBut far off, {weather}, something stirs. {Character2} arrives as a {role} {setting.placed|event.placed}, carrying {item} — small and strange and just enough. What starts vast and dark narrows to one thing: {wish.bare}. A {tone} legend about {moral.about}.',
  ...
  // Shape: daring-escape
  'They were already running when {weather.noun} hit. The quiet morning {setting.placed|event.placed} — gone. {Hook} made sure of that. {Character1.emotional} pulled {character2} along without a word.\n\nThings got worse before they got better. But {item} changed everything, and the escape clawed its way up from the dark. All they wanted was {wish}. A {tone} tale about {moral.about}.',
  ...
  'What would you do? {Setting.placed|event.placed}, {weather}, {character1.emotional} faces {hook}. As the {role}, they must help {character2}, or protect what they have. They can\'t do both.\n\n{Item} makes the choice harder, not easier. But every promise demands a decision. This one is {tone} — and it comes down to {wish.bare} and {moral.about}.',
  ...
  // Shape: crossed-paths
  'Here\'s the thing about {character1} and {character2.emotional} — they were both headed for {event}, but neither one knew the other was coming. One carried {item}. The other carried {hook}. {Weather}, both paths pointed the same way.\n\nThey hadn\'t seen each other since the last time everything went wrong. Now here they are — {role} and old friend, standing {setting.placed}, holding the pieces of something that only works if you put it together. A {tone} tale about {wish.bare} and {moral.about}.',
  ...
  // Shape: old-wounds
  'Can you really forgive someone who was once your {role}? {Character1.emotional} wasn\'t sure. The last time they faced {character2}, it ended with {hook} — and neither walked away clean.\n\n"I brought something." The {character2.bare} holds out {item}, right there {setting.placed|event.placed}, {weather}. The past feels closer than it should. A {tone} story about {wish.bare} — and whether {moral.about} is something you earn or something you choose.',
