...
export const templates = [
  ...
  // Shape: big-event
  'They say that once a year, {weather}, something strange happens in {setting|event}. The lights go out. The shadows line up. And if you\'re very quiet, you can hear {hook} — not as a threat, but as a procession. The midnight parade. {Character1.emotional} had heard the stories. {Character2}, the {role}, had marched in one.\n\n{Item} was the invitation — left at the foot of the bed, glowing faintly. Joining the parade wasn\'t dangerous. Missing it was the real loss. A {tone} tale about {wish.bare} and {moral.about}, told between midnight and dawn.',
  ...
  'Spending the night in {setting|event} was {character1.emotional}\'s idea. Terrible ideas usually are. {Character2}, the {role}, came along because someone had to keep watch. {Weather}, the plan was simple: stay until sunrise, prove {hook} wasn\'t real, go home.\n\nThe plan lasted about an hour. Then {item} moved. Then something laughed — not mean, just amused. The night that followed was {tone} and weird and nothing like either of them expected. All they wanted was {wish}. A tale about {moral.about}.',
